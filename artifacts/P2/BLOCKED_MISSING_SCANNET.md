...
- Blocking error codes: `label_database_invalid_or_missing, metric_taxonomy_invalid_or_missing, processed_database_count_mismatch, processed_database_missing, processed_database_scene_missing, processed_global_file_missing, raw_scene_assets_incomplete, scannet_label_map_missing, scannet_processed_root_missing, scannet_raw_root_missing`.
