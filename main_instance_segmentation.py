...
# 2112 samples / 2 ranks / batch 2 / accumulation 8 * 450 epochs.
_P2_FORMAL_OPTIMIZER_STEPS_PER_EPOCH = 66
_P2_FORMAL_GRADIENT_ACCUMULATION_STEPS = 8
_P2_FORMAL_TRAIN_BATCHES_PER_EPOCH = (
    _P2_FORMAL_OPTIMIZER_STEPS_PER_EPOCH * _P2_FORMAL_GRADIENT_ACCUMULATION_STEPS
)
