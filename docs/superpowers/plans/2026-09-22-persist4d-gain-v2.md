...
- [ ] Select at most one mechanism + same-LR C0 (or C0-only positive branch), continue fixed schedule to3000, CAL-lock then SEL-select P. FULL_PROMOTION selects exactly C0-L-s45 and Q-SEM-L-s45 by PILOT_GATE. Q-SEM250 has the highest new-arm CAL ranking (mean/minimum/long deltas+0.00476592/+0.00027916/+0.00539930). At2026-09-23 05:13 UTC C0-L began exact750→3000 continuation, then Q-SEM will follow on the same2-GPU FP32 runtime. The restored plan starts at draw24000 of96000 with the registered57dc334b sample stream; live progress reached751. Measured pair prediction30.975538 GPU-hours passes the1.25 safety factor while preserving40 confirmation GPU-hours. Full training, six-point CAL selection and SEL selection remain outstanding. The downstream supervisor stays paused until PERCEPTION recovery completes.
