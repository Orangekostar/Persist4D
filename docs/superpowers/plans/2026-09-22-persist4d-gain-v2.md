...
- [ ] Run A-OPEN/Q-SEM/S-WORST in protocol order with explicit skips. A-OPEN-L completed750 updates and all0/250/750 CAL probes cover23/23. Q-SEM-L completed750 at2026-09-23 02:22 UTC (5.162590 measured training GPU-hours); its zero-step CAL is complete and250/750 CAL evaluation continues. The real endpoint audit passes:750 updates,6000 local batches,24000 global draws,2 rank RNG states,1 optimizer/scheduler, scheduler epoch750, and all6 scorer tensors unchanged. S-WORST remains pending. Watchdog fix32aa42e is now verified through Q-SEM's live training-to-evaluation handoff; its21 runner tests also pass. The A-OPEN failure attempt and all costs remain preserved. The downstream supervisor stays paused until AUX/PERCEPTION recovery completes. Keep scorer frozen and separate its steps/cost.
...
- [x] CAL-lock one A*, evaluate once on SEL, keep separate from refiner candidates. CAL_LOCK selects A0-U tau0.73, with mean/minimum/long deltas−0.00166284/−0.00377811/−0.00242119 versus R1. Its single SEL evaluation completed24/24 with exact D0 parity at2026-09-23 02:06 UTC; SEL mean/minimum/long deltas are+0.00024155/−0.00037879/−0.00011113. It fails the registered adoption gate, so association retains D0. Recovery02 exited0 with COMPLETE search and selection, no failures/pruning, and a verified result hash. All association attempts and wrapper overhead total8.087655 CPU-core-hours of16. The completion event will be adopted after the active AUX controller releases RUN_STATE ownership.
